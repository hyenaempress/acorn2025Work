...
📘 이 문서는 Acorn Academy 수업을 수강하며 강의 내용을 개인적으로 재구성하고 확장한 개인 학습 아카이브입니다. 강의 흐름을 기반으로, 학습자의 온보딩과 반복 학습에 최적화된 형태로 재정리하였습니다.
...
- **데이터베이스**: `19.01~19.03` (SQLite + MariaDB 완전정복)
...
| **실무 DB 연동** | `19.02 + 19.03` (MariaDB 연결 + 분석시각화) |

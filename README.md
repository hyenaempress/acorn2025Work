...
- **기존 과정 완주**: NumPy, pandas, Django, 통계학 기초 완료 필수
- **선형대수 기초**: 벡터, 행렬, 내적 개념 (NumPy로 충분)
- **통계학 심화**: 회귀분석, 가설검정 활용 능력
...
9. **통계학 기초**: `22` 시리즈 (기술통계 + 추론통계) ⭐ **NEW**
10. **심화 학습**: `11` 시리즈 (알고리즘)
11. **AI/ML 전문**: `39~42` 시리즈 ⭐ (AI 전문가) **NEW**
...
- **자연어 처리**: `21.01` (KoNLPy)
- **통계학**: `22.00~22.02` (DIKW 피라미드 + 기술통계 + 추론통계) ⭐ **NEW**
...
- **2025-08-13**: 통계학 검정 방법 총정리 추가 (22.04, 실무 가이드 + 22.05.06 카이제곱/p-value 심화)
